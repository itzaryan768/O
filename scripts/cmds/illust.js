...
module.exports = {
 ...
 ar: "{pn} <Ø§Ù„Ù…ÙˆØ¬Ù‡> [--ar <Ù†Ø³Ø¨Ø©>] [--s <Ù†Ù…Ø·>]"
 }
 },
 ...
 return message.reply("âŒ | Only admins and VIP members have permission");
 }
 ...
 return message.reply(`âŒ | Invalid style: ${style}. Please provide a valid style number (1-9).`);
 }
 ...
 return message.reply("âŒ | Invalid selection. Please reply with a number between 1 and 4.");
 }
 ...
 message.reply("âŒ | Failed to send selected image.");
 }
 }
